...
port_ser_2: str = "496732423446"  # Серийный номер пульта СОМ7
...
# # Функция отправки комманды MUXOUT
# def get_bit_muxout() -> str:
#     ser.write('pw11011000'.encode('utf-8'))
#     return ser.readline().decode('utf-8')
#     # print('Data to sent', data, 'Received data', decoded_response[0:-1])
...
def get_file_txt():
    ...
    regmap_file = open(r"c:\Dev\kia\ADF435x_ADF5355_register_values_10000_99.txt")
    ...
    # rf_out_int = (int(FREQ_PFD * (int_n + int_frac_one / DENOMINATOR))) / 1000000
    rf_out_int = int(FREQ_PFD * (int_n + int_frac_one / DENOMINATOR))
    print(rf_out_int)
...
def get_enter_freq():
    while True:
        ...
        # int_n = int((rf_out * 1000000) / FREQ_PFD)
        # print('int_n   ', int_n)

        # FRAC1 - 25-битное значение, установленное битами [28:4] в регистре 1
        int_frac_one_ost = (rf_out * MHZ_TO_HZ / FREQ_PFD - int_n) * DENOMINATOR
        # print('int_frac_one_ost ', int_frac_one_ost)
        int_frac_one = round(int_frac_one_ost)
        # print('int_frac_one', int_frac_one)
        ...
        # print('\nHex', hex(int_frac_one), 'Byte', regbyte)
        print('\nHex', hex(int(regbyte, 2)).upper(), 'Byte', regbyte)
        #print('regbyte.zfill(25) frac1 ', regbyte)
